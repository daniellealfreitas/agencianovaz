...
@section('title', 'NovazXXX - Conteúdo adulto, venda de packs, vídeos, contos eróticos e produtos de sexshop 55+ 48 9 8828-8309')
        ...
        <div class="header-overlay">
            <div class="header-content">
                ...
                <div class="header-btn-area">
                    ...
                    <a class="download-btn" href="#contact">ASSINAR</a>
                </div>
            </div>
        </div>
    </div>
